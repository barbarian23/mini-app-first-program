<template>
  <div class="out shadow_gray mb10">
    <div class="top_card fs12  shadow_gray posre" v-if="type == 'plus'">
      <img src="https://you-one-stand.oss-cn-shanghai.aliyuncs.com/yimai_photos/user/card-case-card-bg2.png" class="w116 h105 bg-img" alt="">
      <div class="zIndex100 pl34 pt25 cblue fs12 flex-sb-c"><span class="before_line_3">{{card_msg.company || lang.text_7}}</span>
      ...
      <div class="top_msg zIndex100 disflex pt15"  @click="page_turn('index')">
        ...
        <div class="pl10 info-content pt10">
          <p class="fbold c38 fs18">{{card_msg.username || lang.text_8}}</p>
          <p class="fs14 ca8 pt10 pb25">{{card_msg.post || lang.text_9}}</p>
        </div>
      ...
      <div class="flex-sa-c btf5f6 operate-bottom">
          <div v-if="!isLogin" class="phone flex-c-c" @click.self="makePhone">
            ...
            <span class="fs14 ca8">{{ lang.text_0 }}</span>
          </div>
          ...
          <button class='bgfff contentbox share-button flex-c-c'
                  ...
                  open-type="share">
            <img src="https://you-one-stand.oss-cn-shanghai.aliyuncs.com/yimai_photos/user/card-case-forward-square2.png" alt="" class="w16 h16 mr11">
            <span class="fs14 ca8">{{ lang.text_1 }}</span>
          </button>
      </div>
    </div>
    ...
    <!-- <div class="pt15 pl16 pr15 pt16 bgfff pb15" v-else @click="page_turn('index')">
      <div class="top_card fs12 shadow_gray pb42">
        <div class="pl34 pt25 cblue fs12"><span class="before_line_3">{{card_msg.company || lang.text_7}}</span></div>
        <div class="top_msg disflex jsbet pt41">
          <div>
            <p class="fbold c38 fs18">{{card_msg.username || lang.text_8}}</p>
            <p class="fs14 ca8 pt10 pb23">{{card_msg.post || lang.text_9}}</p>
            <p class="fs12 c78">{{card_msg.tel || lang.text_10}}</p>
            <p class="fs12 c78">{{card_msg.email || lang.text_11}}</p>
          </div>
...
import LangUtils from '../utils/LangUtils';
  ...
  export default {
    ...
    data(){
      return{
        lang: LangUtils.getLangSrc().components.BusinessCard,
    ...
    methods:{
      ...
      page_turn(url){
        ...
        wx.switchTab({url:'../'+url+'/main?cardId='+this.card_msg.companyId+'&companyId+'+this.card_msg.cardId});
      },
      moreTap(){
