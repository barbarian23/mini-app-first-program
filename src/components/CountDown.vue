<template>
  <div class="disinblock">
    <div class="count-down-zh align-cen"
      ...
      <span class="unit">{{ lang.text_0 }}</span>
      <span class="date">
        {{timeObj.hour}}
      </span>
      <span class="unit">{{ lang.text_1 }}</span>
      <span class="date">
        {{timeObj.min}}
      </span>
      <span class="unit">{{ lang.text_2 }}</span>
      <span class="date">
        {{timeObj.sec}}
      </span>
      <span class="unit">{{ lang.text_3 }}</span>
    </div>
    <div class="count-down"
      ...
      <span class="unit day spans"  v-if="timeObj.day !=0">{{ lang.text_4 }}</span><span class="spans">{{timeObj.hour}}</span>:
    ...
    <div class="count-down-zh align-cen"
      ...
      <span class="unit day"  v-if="timeObj.day !=0">{{ lang.text_4 }}</span><span class="date">{{timeObj.hour}}</span>:<span class="date">{{timeObj.min}}
...
import LangUtils from '../utils/LangUtils';
  export default {
    ...
    data(){
      return {
        lang: LangUtils.getLangSrc().components.CountDown,
        time: 0,
        timeObj: {},
        timer: null,
      };
