<template>
  <div class="fix_bottom bgfff edit_input trans2"
    ...
    <div class="im_bottom animated disflex align-cen pl15 pr15 pt5 pb5 bgfff borderbox"
      ...
      <div class="disflex">
        <img v-if="isInput"
             src="https://you-one-stand.oss-cn-shanghai.aliyuncs.com/yimai_photos/voice_off.png"
             class="icon"
             @click="voice" />
        <img v-else
             src="https://you-one-stand.oss-cn-shanghai.aliyuncs.com/yimai_photos/input.png"
             class="icon"
             @click="keyboard" />
      </div>
      <input v-if="isInput"
      ...
      <div @touchstart="touchStartEvent"
              ...
              style="height: 75rpx;color: #383838;border: 2px solid #E8E8E8; flex-grow: 1;">
        {{text}}
      </div>
      <div class="">
        <span style="line-height: 58rpx"
              class="disblock w65 textc bblue cblue fs16 bradius5"
              @click="useful_tap">{{ lang.text_0 }}</span>
        <!---->
      </div>
      <div class="disflex ml10">
        <img src="https://you-one-stand.oss-cn-shanghai.aliyuncs.com/yimai_photos/more.png"
             @click="more"
             class="icon" />
      </div>
    </div>
    ...
    <!--更多-->
    <div v-if="isMore"
         style="border-top: 2upx solid #E8E8E8;margin-bottom:25px;"
      ...
      <div @click="photo">
        <div style="border: 2upx solid #E8E8E8;border-radius:10rpx;width: 96rpx;height: 96rpx;"
          ...
          <img src="https://you-one-stand.oss-cn-shanghai.aliyuncs.com/yimai_photos/photo.png"
               style="height: 60rpx; width: 60rpx;"
               mode="widthFix" />
        </div>
        <div class="textc mt5 fs12 c78">{{ lang.text_1 }}</div>
      </div>
      <div @click="shot"
           style="margin: 0 67rpx;">
        <div style="border: 2upx solid #E8E8E8;border-radius:10rpx;width: 96rpx;height: 96rpx;"
             class="disflex align-cen jscen">
          <img src="https://you-one-stand.oss-cn-shanghai.aliyuncs.com/yimai_photos/camera.png"
               style="height: 60rpx; width: 60rpx;"
               mode="widthFix" />
        </div>
        <div class="textc mt5 fs12 c78">{{ lang.text_2 }}</div>
      </div>
      <div @click="video">
        <div style="border: 2upx solid #E8E8E8;border-radius:10rpx;width: 96rpx;height: 96rpx;"
             class="disflex align-cen jscen">
          <img src="https://you-one-stand.oss-cn-shanghai.aliyuncs.com/yimai_photos/video.png"
               style="height: 60rpx; width: 60rpx;"
               mode="widthFix" />
        </div>
        <div class="textc mt5 fs12 c78">{{ lang.text_3 }}</div>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  data () {
    return {
      lang: LangUtils.getLangSrc().components.editInputer,
      comment_focus: false,
      comments: ''
    }
  },
