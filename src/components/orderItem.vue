        ...
        <div class="disflex w100p pr16">
          ...
          <div class="flex1">
            ...
            <div class="mt8"
              ...
              <div>
                <span class="pl7 pr8 lh20 fs12 ca8 mr8">￥{{prod_item.isKill ? prod_item.killPrice : prod_item.price}}</span>
              </div>
            </div>
            <!--加减-->
            <div class="disflex jsbet align-cen"
                 v-if="iscart"
                 @click.stop="''">
              <span class="cdeeporange fs14"><span>￥</span><span>{{prod_item.isKill ? prod_item.killPrice : prod_item.price}}</span></span>
...
export default {
  ...
  data() {
    return {
      lang: LangUtils.getLangSrc().components.orderItem,
      company_check: false
    };
  },
  mounted() {
