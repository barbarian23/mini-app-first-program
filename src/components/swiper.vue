<template>
  <view class="swiper-wrap-self " :class="self_class">
    <swiper class="swiper-inner" :class="swiper_height_class ? 'swiper-height' : '' "  @animationfinish="animationfinish" :indicator-dots="indicator" :current="cur" :circular="circular"
      :autoplay="autoplay" :interval="interval" :duration="duration">
      <block v-for="(item,index) in imgUrls" :index="index" :key="index">
        <swiper-item :class="swiper_item_class">
          <image class="banner-img" :src="item" @click="swipclick(index)"></image>
...
<script>
  export default {
    ...
    props: {
      ...
      swiper_item_class:{//swiper-item class
        type: String,
        default: '',
      },
      swiper_height_class:{
