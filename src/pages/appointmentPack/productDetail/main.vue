<template>
  <div class="pb50">
    <SelfSwiper :imgUrls="images"
                :self_class="'h375'"></SelfSwiper>
    ...
    <div class="bgfff pl16 pr15 pb15 mb10">
      ...
      <div class="disflex jsbet">
        ...
        <!--          <img src="https://you-one-stand.oss-cn-shanghai.aliyuncs.com/yimai_photos/user/share.png" alt="" class="w15 h15 mr7">-->
    ...
    <!-- 宝贝详情 -->
    <div>
      <p class="lh43 textc fs14 ca8">{{ lang.text_1 }}</p>
      <div class="bgfff"
           v-html="goodsMsg.goodsDetails"></div>
    </div>

    <p class="lh43 textc fs12 ca8">{{ lang.text_2 }}</p>
    ...
    <div class="index_float_right trans2 overhidden">
      ...
      <div :class="{fadeInRight: !isShow, fadeOutRight: isShow}"
        ...
        <div class="pt16"
          ...
          <img src="https://you-one-stand.oss-cn-shanghai.aliyuncs.com/yimai_photos/user/right_row.png"
               alt=""
    ...
    <div class="disflex fix_bottom bte8"
      ...
      <div class="disflex flex1 bgfff textc">
        <div class="w50p pt7"
             @click="toProductList">
          <img src="https://you-one-stand.oss-cn-shanghai.aliyuncs.com/yimai_photos/user/prod_select.png"
               alt=""
               class="w20 h20">
          <b class="cblue fs12 textc mt-4">{{ lang.text_3 }}</b>
        </div>
        <div class="w50p pt7"
             @click="makePhone">
          <img src="https://you-one-stand.oss-cn-shanghai.aliyuncs.com/yimai_photos/user/tel_gray.png"
               alt=""
               class="w20 h20">
          <b class="ca8 fs12 textc mt-4">{{ lang.text_4 }}</b>
        </div>
      </div>

      <div class="w250 bg_line_orange fbold textc fs18 cfff lh49 disflex align-cen jscen"
           @click="toAppointment">
...
export default {
  ...
  data() {
    return {
      lang: LangUtils.getLangSrc().appointmentPack.productDetail,
      canbuy: true,//是否可以支付
      indicatorDots: true,
      autoplay: true,
      interval: 3000,
      duration: 500,
      img: 'https://you-one-stand.oss-cn-shanghai.aliyuncs.com/yimai_photos/user/food.jpg',
      images: [],
      typeId: 0,
      goodsPrice: '',
      goodId: 0,
  ...
  onShareAppMessage(e) {
    ...
    addShareRecord(this.currentCompany.companyId, 3, this.goodId, uuid).then(res => { }, err => { });
    return {
      title: this.goodsMsg.name,
      path: '/pages/appointmentPack/productDetail/main?goodId=' + this.goodId
        + '&cardId=' + this.cardId
        + '&tel=' + this.cardTel
        + '&companyId=' + this.currentCompany.companyId
        + '&goType=1&shareId=' + uuid,
      imageUrl: url,
    }
  },
  methods: {
    ...
    toAppointment() {
      wx.navigateTo({ url: `/pages/appointmentPack/addAppointment/main?productsId=${this.goodId}` });
    },
    makePhone() {//拨打电话
