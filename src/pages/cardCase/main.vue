    ...
    <scroll-view :style="{height: scrollContentHeight+'px'}"
      ...
      <div class="bgfff pl15 pb10 pr15"
        ...
        <div class="bgf5f6 bradius17 textc lh34 disflex align-cen pl25 search trans2 pr25"
          ...
          <span class="searchText over_1"
                v-if="!isfocus">{{searchkey || lang.text_3}}</span>
          <input type="text"
                 v-model="searchkey"
      ...
      <div class="bgfff pt15 pl16 pr15">
        ...
        <div class=" my-card-case flex-sb-c pb15">
          <p class="flex-c-c"> <span class="separator"></span> <span class="fs16 pl9">{{ lang.text_4 }}</span></p>
          <div class="right flex-sb-c">
            <span class="fs16 cblue pr8"
                  v-if="lists.length>0">{{lists.length}}</span>
            <img class="card-case-num-img "
                 src="https://you-one-stand.oss-cn-shanghai.aliyuncs.com/yimai_photos/user/card-case-num.png"
                 alt="">
          </div>
        </div>
          ...
          <div class="bradius10"
            ...
            <div class="bgfff bradius10">
              <BusinessCard :card_msg="v"
                            ...
                            @needLogin="needLogin"
                            @moreTap="moreTap"
                            @shareApp="shareApp"></BusinessCard>
            </div>
          </div>
        ...
        <!--bottom-->
        <!-- <div class="textc lh70 fs12 ca8 bgf5f6" v-if="nodata">{{ lang.text_0 }}</div> -->
        <!-- 创建自己的名片 -->
        <InsertCard v-if="!hasCard"
                    @loginSuccess="loginSuccess"
                    :isLogin="isLogin"></InsertCard>
        ...
        <!-- <div class="add_card" :class="{'w100p': !hasCard}">
                    ...
                    >
                        ...
                        <span>{{ lang.text_1 }}</span>
                        <div class="fbold create" >
                            <view v-if="isLogin">{{ lang.text_2 }}</view>
                        </div>
                    </p>
                    <div class="textc disflex w60 h60 bradius50p bgblue disinblock" @click="page_turn('usercenter')" v-else>
                        <img src="https://you-one-stand.oss-cn-shanghai.aliyuncs.com/yimai_photos/user/user_add.png" alt="" class="w30 h30 mt15">
                    </div>
...
export default {
  name: '',
  components: { MeCard, BusinessCard, SelectorOne, GetPhoneNumber, getPhoneNumberCard, AppNotice, NavBarByUser, InsertCard },
  data() {
    return {
      lang: LangUtils.getLangSrc().cardCase,
      searchkey: '',
      last_searchkey: '',
      isfocus: false,
      mine_card: {},
