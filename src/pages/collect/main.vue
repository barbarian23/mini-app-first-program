<template>
  <div class="pt46">
    ...
    <div class="disflex bgfff textc jsaround fs16 lh44 c78 bbf7 fix_top zindex999 bgfff">
      <span class="" :class="menu_id == 1 ? 'bbblue_2 cblue fbold' : '' " @click="menu_tap(1)">{{ lang.text_0 }}</span>
      <span class="" :class="menu_id == 2 ? 'bbblue_2 cblue fbold' : '' " @click="menu_tap(2)">{{ lang.text_1 }}</span>
      <span class="" :class="menu_id == 3 ? 'bbblue_2 cblue fbold' : '' " @click="menu_tap(3)">{{ lang.text_2 }}</span>
    </div>
    <!--收藏企业-->
    ...
    <!--bottom-->
    <div class="textc lh42 fs12 ca8 bgf5f6" v-if="nodata">{{ lang.text_3 }}</div>
