  ...
  <div>
    ...
    <div class="disflex jsbet bgfff lh30 pl16 pr15 pt5 pb5">
      <div class="pr15" @click="chooseCity('searchChooseItem','city')">
        ...
        <img src="https://you-one-stand.oss-cn-shanghai.aliyuncs.com/yimai_photos/crm/down_2.png" alt="" class="w10 h10">
      </div>
      <div class="bgf5f6 bradius17 disflex pl15 flex1 align-cen">

        <img src="https://you-one-stand.oss-cn-shanghai.aliyuncs.com/yimai_photos/crm/search.png" alt="" class="w16 h16 mr8">
    ...
    <div class="pl16 bgfff pt15 pb15 pr16" v-show="!key">
      ...
      <div class="disflex jsbet pt10">
        ...
        <span class="cblue fs16" @click="getlocation">{{ lang.text_1 }}</span>
      </div>
    </div>
    <!--addr lists-->
    <div v-show="key">
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        lang: LangUtils.getLangSrc().companyAddr,
        locat: {
          city: '成都',
          addr: '',
          lat: '',
