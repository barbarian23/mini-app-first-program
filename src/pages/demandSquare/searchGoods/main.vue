    ...
    <div class="pt44">
        <div class="disflex jsbet bgfff lh30 pl16 pr15 pt5 pb5 posfix top0 left0 w100p borderbox">
            <div class="bgf5f6 bradius17 disflex pl15 flex1">
                ...
                <input type="text" v-model="key" class="pl15 pha8 fs14 lh34 h34 w100p c38" @confirm="search" placeholder="请输入产品名称搜索">
            </div>
...
export default {
    ...
    data () {
        return {
          lang: LangUtils.getLangSrc().demandSquare.searchGoods,
            goodsList: [],
            haveNoSearch: true,
            pageNum: 1,
            key: '',
    ...
    methods: {
        ...
        getGoodsList(){
            ...
            WXAJAX.POST(params, '', '/goods/getGoodsList/demand')
            .then(data => {
                wx.hideLoading();
